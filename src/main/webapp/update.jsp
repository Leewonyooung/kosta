...
<div class="signUp">
	...
	<form id="updateForm" action="<c:url value="/facility/update"/>" method="post">
		<input type="hidden" name="id" value="${facility.fac_id }"><!-- TODO value -->
		<table>
			<colgroup>
				<col style="width: 25%;">
				<col style="width: 75%;">
			...
			<tbody>
				<tr>
					<th>시설유형</th>
					<td><input type="text" value="${facility.fac_type_name }" readonly></td>
				</tr>
				<tr>
					<th>시설명</th>
					<td><input type="text" name="name" value="${facility.fac_nm }" placeholder="시설명" required>*시설명을 입력해주세요</td>
				</tr>
				<tr>
					<th>이용료</th>
				...
				<tr>
					<th>사용가능시간</th>
					<td><input type="text" value="${facility.available_time }" readonly></td><!-- TODO value -->
				</tr>
				<tr>
					<th>ETC</th>
